...
function buildSections(options?: { includeFtcFieldSwitcher?: boolean }): DocSection[] {
  const includeFtcFieldSwitcher = options?.includeFtcFieldSwitcher ?? false;
...
export const docsRegistry: DocsRegistry = {
  ...
  projects: [
    ...
    },
    {
      ...
      title: "Flashruler",
      tabLabel: "Flashruler",
      sections: buildSections({ includeFtcFieldSwitcher: true }),
    },
    {
      id: "iris",
      title: "Iris",
